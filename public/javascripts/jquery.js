    ...
    a.fn.lazyload = function (d) {
        function h() {
            ...
            e.each(function () {
                ...
                if (!a.abovethetop(this, g) && !a.leftofbegin(this, g))if (!a.belowthefold(this, g) && !a.rightoffold(this, g))c.trigger("appear"); else if (++b > g.failure_limit)return!1
            })
        }

        var e = this, f, g = {threshold: 0, failure_limit: 0, event: "scroll", effect: "show", container: b, data_attribute: "original", skip_invisible: !0, appear: null, load: null};
...
$("header>div>nav>ul>li>a").hover(function () {
    $(this).parent().stop(false, true).animate({"background-position-y": "0", opacity: "1"}, {duration: "normal", easing: "easeInBack"});//��꾭�������
}, function () {
    $(this).parent().stop(false, true).animate({"background-position-y": "-37px", opacity: "1"}, {duration: "normal", easing: "easeInBack"});//���out������
});