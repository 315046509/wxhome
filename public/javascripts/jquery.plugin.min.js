...
$("header>div>nav>ul>li>a").hover(function () {
    $(this).parent().stop(false, true).animate({"background-position-y": "0", opacity: "1"}, {duration: "normal", easing: "easeInBack"});//鼠标经过的样子
}, function () {
    $(this).parent().stop(false, true).animate({"background-position-y": "-37px", opacity: "1"}, {duration: "normal", easing: "easeInBack"});//鼠标out的样子
});